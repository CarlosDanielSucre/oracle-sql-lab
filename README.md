...
- [x] [What is a database? Data vs. Information.](concepts/module1/database.md)
- [x] [Relational model: tables, columns, keys.](concepts/module1/relational-model.md)
